...
OPERATION_ROLES: dict[str, tuple[str, ...]] = {
    ...
    "view_audit_log": (ROLE_PLATFORM_ADMIN,),
    ...
    "manage_issues_api": (ROLE_PLATFORM_ADMIN, ROLE_DATA_INTEGRATOR),
...
OPERATION_LABELS_RU: dict[str, str] = {
    ...
    "view_audit_log": "Журнал аудита (действия в workspace)",
    ...
    "manage_issues_api": "API v1: resolve/ignore для проблемных записей",
